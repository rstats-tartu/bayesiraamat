...
```{r, fig.cap="Lihtne mudel y ~ x, mille intecept = 0 ja tõus = 1."}
...
```{r, fig.cap=paste0('Lineaarne mudel, mille intecept = ", a ," ja tõus = 1.. Katkendjoon, lõikepunkt = 0. Pidevjoon, lõikepunkt = ', a,".")}
...
```{r, fig.cap=paste0('Lineaarne mudel, mille intercept = 0 ja tõus = ', b, '. Katkendjoon, tõus = 1. Pidevjoon, tõus = ', b, '.')}
