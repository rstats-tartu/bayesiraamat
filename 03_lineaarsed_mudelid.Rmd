...
```{r echo=FALSE, fig.height=3, fig.width=6, fig.cap="Kasvava paindlikusega polünoomsed mudelid. mod_e1 on sirge võrrand y = a + b~1~x (2 parameetrit: a ja b~1~), mod_e2 on lihtsaim võimalik polünoom: y= a + b~1~x + b~2~x^2 (3 parameetrit), ..., mod_e5: y= a + b~1~x + b~2~x^2 + b~3~x^3 + b4x^4 + b5x^5 (6 parameetrit). mod_e5 vastab täpselt andmepunktidele (N = 6)."}
dfr <- tibble(x = c(2, 3, 2.2, 5, 7, 8), y = c(8, 5, 9, 10, 11, 10.1))
mod_e1 <- lm(y ~ x)
