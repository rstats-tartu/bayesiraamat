...
```{r, fig.cap=paste0('Lineaarne mudel. Katkendjoon, lõikepunkt = 0. Pidevjoon, lõikepunkt = ', a,".")}
...
```{r, fig.cap=paste0('Lineaarne mudel. Katkendjoon, tõus = 1. Pidevjoon, tõus = ', b,".")}
...
```{r, fig.cap='Lineaarne mudel lõikepunkti ja tõusuga.'}
...
```{r, fig.cap='Linear model predicting Sepal.Length from Petal.Length from iris dataset.'}
