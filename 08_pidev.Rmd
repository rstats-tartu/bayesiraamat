...
# Ennustame Pidevat suurust {#pidev}
...
```{r fig.cap="Cauchy prior", fig.height=3, fig.width=3}
x <- 0:100
y <- dcauchy(x, 0, 20)
plot(y ~ x, type = "l" , main = "Cauchy prior for sd")
```

```{r fig.cap="Normaaljaptuse prior", fig.height=3, fig.width=3}
x <- 150:200
y <- dnorm(x, 0, 200)
...
```{r fig.cap="veel üks Normaaljaptuse prior.", fig.height=3, fig.width=3}
x <- 150:200
y <- dnorm(x, 178, 10)
...
```{r fig.cap="Posteeriorite CI plot", fig.height=3, fig.width=4}
library(bayesplot)
...
```{r fig.cap="Posteeriorite tihedusplot.", fig.height=3, fig.width=4}
...
```{r fig.cap="Posteerior uuele parameetrile", fig.height=2, fig.width=3}
...
```{r fig.cap="Võrdlev plot mitme mudeli posteerioritele.", fig.height=3, fig.width=4}
...
```{r fig.cap="Prior keskmisele.", fig.height=2, fig.width=3}
x <- -500:500
y <- dnorm(x, 0, 200)
...
```{r fig.cap="Prior SD-le", fig.height=2, fig.width=3}
x <- 0:200
y <- dcauchy(x , 0, 10)
...
```{r fig.cap="Traceplot.", fig.height=4, fig.width=4}
tracerplot(potusm2.1, n_cols = 2)
```


Tulemus ES-i osas tuleb üsna sarnane.
```{r fig.cap="mudelite võrdlusplot.", fig.height=4, fig.width=4}
...
```{r fig.cap="Posteerior ES-le.", fig.height=2, fig.width=3}
...
```{r fig.height=3, fig.width=4, fig.cap="Nulli surutud interceptiga lineaarne regressioon eluea sõltuvusele SKP-st."}
...
```{r fig.cap="Täismudeliga regressioon.", fig.height=3, fig.width=4}
plot(g2007$gdpPercap, g2007$lifeExp, ylim = c(0, max(g2007$lifeExp)))
abline(gapmod2)
...
```{r fig.cap="Mudelite võrdlusplot.", fig.height=3, fig.width=4}
...
```{r fig.cap="Log skaalas töötab nulli surutud interceptiga mudel sama hästi kui täismudel. See ei ole paraku mudeldamise üldine omadus.", echo=FALSE, fig.height=3, fig.width=4}
coefs7 <- coef(gapmod7)
coefs8 <- coef(gapmod8)
...
```{r fig.cap="Ennustus mudelist kindlale l_GDP väärtusele.", fig.height=2, fig.width=3}
dens(sim.length$V10)
...
```{r fig.cap="SKP-de jaotus", echo=FALSE, fig.height=3, fig.width=4}
...
```{r fig.cap="Mudeli tõus sõltub interceptist.", fig.height=3, fig.width=3}
...
```{r fig.cap="Mudeli tõusude (beta) posteerior.", fig.height=2, fig.width=3}
dens(beta)
```
...
```{r fig.cap="m.resid ~ Y plot", fig.height=3, fig.width=4}
...
```{r fig.cap="Ennustav plot", fig.height=3, fig.width=4}
...
```{r fig.cap="valimi andmed vs. mudeli poolt ennustatud andmed.", fig.height=4, fig.width=5}
...
```{r fig.cap="Ennustus vs. valimi väärtus", fig.height=3, fig.width=5}
mu <- link(m5)  
mu.mean <- apply(mu, 2, mean)
...
```{r fig.height=10, fig.width=5, fig.cap="Ennustused riigi kaupa."}
# compute residuals
...
```{r fig.cap="Ennustusplot Aafrikale.", fig.height=3, fig.width=4}
...
```{r fig.cap="Ennustusplot Euroopale.", fig.height=3, fig.width=4}
...
```{r, fig.height=9, fig.cap="mudelite koefitsiendid."}
