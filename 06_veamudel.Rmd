...
Kui teil on binaarne muutuja (sellel saab olla ainult kaks väärtust, näiteks edukas/edutu), mis kajastab sõltumatuid sündmusi, siis modelleerib seda binoomjaotus $y ∼ Binomial(n, p)$.
