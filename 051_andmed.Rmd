...
```{r,fig.cap="Anscombe'i kvartett illustreerib korrelatsioonikordaja lineaarset olemust: 4 andmestikku annavad identse nullilähedase korrelatsioonikordaja, ehkki tegelikud seosed andmete vahel on täiesti erinevad.", echo=FALSE}
library(stringr)
bind_cols(id = 1:11, anscombe) %>% 
  gather(key, value, -id) %>% 
