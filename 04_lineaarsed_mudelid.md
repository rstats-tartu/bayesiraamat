...
3. Normaalsus - residuaalid on normaaljaotusega ehk Y-mmuutuja on normaaljaotusega kõigil X-i väärtustel.

4. Sõltumatus - residuaalide väärtused ei ole omavahel korreleeritud.

5. X-muutuja on fikseeritud: X-i suunal puudub täielikult mõõtmisviga ja ebakindlus, mis tähendab, et x-i väärtused on täpselt teada (me ei ennusta neid). See eeldus on tähtis siis, kui me püüame anda regresioonimudelile põhusliku tõlgenduse. Mudelis $Y = a + b_1X_1 + b_2X_2$ viib mõõtmisviga $X_2$-s viib $b_2$ koefitsiendi nulli suunas ja ühtlasi vähendab $b_2X_2$ liikme mõju b1 fittimisel.  
...
Teisel, põhjuslikul juhul on kõik teisiti. Eeldades et $X_2$ on üks Y-i põhjustest, on nüüd (i) mudeli veakomponendis peidus ka $b_2X_2$. Kui $X_1$ ja $X_2$ on omavahel korreleeritud, siis tekib meil seetõttu ka korrelatsioon $X_1$ ja veakomponendi vahel -- ja see rikub mudeli eeldusi, kallutades mudeli fittimisel meie hinnangut $b_1$-le, misläbi osa $X_2$ mõjust Y-le omistatakse ekslikult $X_1$-le. See kõik juhtub siis, kui (ii) mudeli $b_2$ ei ole null ja esineb $X_1$ ja $X_2$ vaheline korrelatsioon. 
