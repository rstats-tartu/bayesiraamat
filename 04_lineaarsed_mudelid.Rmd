...
Kahvli puhul regressioonimudel $y ~ x$ näitab x-i mõju y-le (ehkki puudub x ja y vaheline põhjuslik seos), aga mudel $y ~ x + z$ välistab selle mõju. Seega peaksime sellise põhjusliku hüpoteesi korral mudelisse z-i sisse panema, sest see aitab kontrollida z konfounding mõju vastu.
