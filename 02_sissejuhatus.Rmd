...
```{r, fig.cap="Keskaegne aristotellik maailm.", out.width='\\linewidth', fig.align='center', echo=FALSE}
...
```{r, fig.cap="Ilma epitsükliteta ptolemailine mudel.", fig.align='center',out.width='\\linewidth', echo=FALSE}
...
```{r, fig.cap="Ptolemaiose ja Kopernikuse mudelid on üllatavalt sarnased.", fig.align='center',out.width='\\linewidth', echo=FALSE}
