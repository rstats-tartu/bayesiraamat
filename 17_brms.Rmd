...
Kui prediktori prosoc_left väärtus muutumine 0-st 1-ks tõstab y=1 sündmuse *log-odds*-i `r round(tidy(m_logreg_2)$estimate[2], 2)` võrra, siis kasvab proportsionaalselt exp(`r round(tidy(m_logreg_2)$estimate[2], 2)`) = `r round(exp(tidy(m_logreg_2)$estimate[2]), 2)` ja *odds*, et toimub sündmus pull left ehk y=1 kasvab 73%.
