...
```{r fig.height=3, fig.width=4, fig.cap="Multiplikatiivse sd joonistamine.", echo=FALSE}
...
8. Cleveland plot on hea countide jaoks. Kasuta Barplotti ainult siis, kui Cleveland plot vm plot mingil põhjusel ei sobi. 
