...
```{r echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), out.width='50%'}
knitr::include_graphics('img/cyclo.png', dpi = NA)
```


```{r, include=FALSE}
knitr::write_bib(c(.packages(), 'bookdown', 'knitr', 'rmarkdown', 'tidyverse', 'broom', 'modelr', 'viridis', 'scatterplot3d', 'rstan', 'rethinking', 'brms', 'car', 'corrgram', 'boot', 'bayesboot', 'gapminder', 'devtools', 'ggthemes', 'grid', 'gridExtra'), 'packages.bib')
```
