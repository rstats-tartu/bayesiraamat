...
4. Kui A ja B ei ole üksteist välistavad, siis $P(A \lor B) = P(A) + P(B) - P(A \land B)$. Kolmele sündmusele: $P(A \lor B \lor C) = P(A) + P(B) + (C) - P(A \land B) - P(B \land C) - P(A \land C) + P(A \land B \land C)$. 
...
```{r sdjaotus, fig.cap="(ref:sdjaotus)"}
Summary %>% 
  ggplot(aes(SD)) + 
  geom_histogram(bins = 40)
```
...
```{r parun, echo=FALSE, fig.cap='(ref:parun)', out.width='50%'}
