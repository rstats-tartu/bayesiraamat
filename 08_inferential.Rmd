...
```{r echo=FALSE}
tibble(A = c("T", "F", "T", "F"), B = c("F", "T", "T", "F"), X=c("", "", "", ""))
```
...
```{r echo=FALSE}
tibble(A=c("T", "T", "F", "F"), B=c("T", "F", "T", "F"), `A and B` = c("T", "F", "F", "F"))
```
...
```{r echo=FALSE}
tibble(A=c("T", "T", "F", "F"), B=c("T", "F", "T", "F"), `A or B (I)` = c("T", "T", "T", "F"), `and (III)`= c("F", "T", "T", "F"), `not (II)`= c("F", "T", "T", "T"), `A and B (I)` = c("T", "F", "F", "F"))
```
...
```{r echo=FALSE}
tibble(A=c("T", "T", "F", "F"), B=c("T", "F", "T", "F"), `A xor B`= c("F", "T", "T", "F"))
```
...
```{r echo=FALSE}
tibble(A=c("T", "T", "F", "F"), B=c("T", "F", "T", "F"), `if A then B`= c("T", "F", "T", "T"))
```
...
(1) et iga sündmuse tõenäosus on suurem või võrdne nulliga, 

(2) et loogiliselt paratamatu sündmuse tõenäosus on üks,  
...
5. $P(A \And B) \le P(A)$, ehk kui B on A alamhulk $[A \lor (B \land \lnot A)  \Leftrightarrow B]$, siis $P(B) \leq P(A)$.  

5.1. Kui tõendusmaterjal e on hüpoteesi h alamhulk, ehk kui h ennustab e-d, ja kui on täidetud tingimused (*i*) $P(h) > 0$ ja (*ii*) $P(e) < 1$, siis $P(h \lvert~ e) > P(h)$, ehk e esinemine tõstab h tõenäosust.

6. Definitsioon: A ja B on üksteisest sõltumatud siis ja ainult siis kui $P(A~ \vert B) = P(A)$ 

7. Kui A ja B on üksteisest sõltumatud, siis $P(A \land B) = P(A)P(B) = P(A~\vert~B)P(B)$ 

8. Kui A ja B ei ole üksteist välistavad, siis $P(A \lor B) = P(A) + P(B) - P(A \land B)$. Kolmele sündmusele: $P(A \lor B \lor C) = P(A) + P(B) + (C) - P(A \land B) - P(B \land C) - P(A \land C) + P(A \land B \land C)$. 

9. Totaalne ehk marginaalne tõenäosus: $P(A) = P(A~\vert~B)P(B) + P(A~\vert~\lnot B)P(\lnot B)$, ehk $P(A) = P(A~\vert~B_1)P(B_1) + P(A~\vert~ B_2)P(B_2) + ...$ kõikidele võimalikele B-le, tuletatud 5. punktist.  

10. Bayesi teoreem: $P(A~\vert~B) =\frac{P(A)P(B~\vert~A)}{P(B)}$ -- tuletatud 5. punktist, kus $P(B) = P(A)P(B~\vert~A) + P(\lnot A)P(B~\vert~\lnot A)$ tuleb 6. punktist.     
