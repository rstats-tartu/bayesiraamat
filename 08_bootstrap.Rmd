...
# Bootstrappimine
>>>>>>> 1442b5df48575cc53caeb88b23a2342d2bd809a5
...
```{r fig.cap="Empiirilise bootstrapi posteerior USA presidentide keskmisele pikkusele."}
boot_mean <- boot_mean %>% 
...
```{r, echo=FALSE, fig.cap="Bootstrappimise meetodid.", out.width='50%'}
