...
```{r pullpost, fig.cap="(ref:pullpost)"}
...
```{r betaparm, fig.cap="(ref:betaparm)", echo=FALSE}
...
```{r, fig.cap="Posteerior, mis on arvutatud beta prioriga binoomsest tõepäramudelist."}
HPDI(samples$p, prob = 0.95) # Highest density 95% at the center
dens(samples$p)
```
