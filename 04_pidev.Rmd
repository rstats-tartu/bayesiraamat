...
Selline andmete sisestamise viis on omane Stan-le -- map2stan arvutab ise kapoti all N-i.
```{r, echo=FALSE}
...
ggplot( g2007, aes( lifeExp, m.resid ) ) +
  ...
  geom_hline( yintercept = 0, color = "grey", linetype = 2 ) +
  theme_tufte()
>>>>>>> be4c0ddf26e39f3f3932ac3c23ab9431c6eac00f
```
...
Plot, kus me ennustame keskmise eluea sõltuvust SKP-st nii riikide kaupa eraldi (andmepunktide paupa) kui üldiselt kõikide riikide keskmisena, millel on mingi kindel SKP (mudeli parima ennustuse ehk sirge asendi ümber valitsevat ebakindlust). Et seda teha, peame hoidma rahvaarvu konstantsena: 
...
=======
    lGDP_s = seq( from = -3 , to = 3 , length.out = 30 ), 
#need meie poolt valitud lGDP_s väärtused, millele me ennustame vastavad eluead 
    lpop_s = 0 
#rahvaarv fikseeritakse muutuja keskmisele tasemele, mis standardiseeritud andmete korral = 0
>>>>>>> be4c0ddf26e39f3f3932ac3c23ab9431c6eac00f
)
