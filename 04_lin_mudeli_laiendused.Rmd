...
```{r fig.height=2, fig.width=4, fig.cap='Normaaljaotus tekib sõltumatutest efektidest. Kümne tuhande N = 12 suuruse juhuvalimi summa tihedusdiagramm.', message=FALSE, error=FALSE}
library(rethinking)
