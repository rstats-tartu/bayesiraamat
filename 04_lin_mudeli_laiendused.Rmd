...
```{r fig.cap="2D-le kollapseeritud graafiline kujutus 3D andmete põhjal fititud mudelist. Muutuja Petal.Length on kollapseeritud konstandile.", message=FALSE, error=FALSE}
library(tidyverse)
...
```{r fig.cap="2D visualiseering 2D andmete põhjal fititud mudelist."}
...
```{r fig.cap="Ennustus ainsa prediktoriga mudelist."}
...
```{r message=FALSE, fig.height=3, fig.width=4, fig.cap="Normaaljaotus ja studenti t jaotus fitituna N = 3 andmetega.", echo=FALSE}
