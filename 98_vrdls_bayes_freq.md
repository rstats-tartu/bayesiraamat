...
![(\#fig:vrdlssd)Paariviisiline katse - kontroll disain. Katset on korratud 30 korda. X-teljel on efektisuurused (ES). 30 üksikut efektisuurust on näidatud punktidena. Must joon näitab keskmist efektisuurust. Andmed on mudeldatud normaaljaotusena.](98_vrdls_bayes_freq_files/figure-latex/vrdlssd-1.pdf) 
...
![(\#fig:vrdlsse)See jaotus iseloomustab keskmise ES paiknemist puhtalt meie andmete põhjal.](98_vrdls_bayes_freq_files/figure-latex/vrdlsse-1.pdf) 
...
![(\#fig:vrdlssdse)Taustateadmiste mudel ehk prior on normaaljaotus (must joon), mille ülesanne on veidi vähendada ekstreemsete valimite kahjulikku mõju.](98_vrdls_bayes_freq_files/figure-latex/vrdlssdse-1.pdf) 
...
![(\#fig:vrdlsnull)Nullhüpotees (must kõver) ja tõepärafunktsioon (punane kõver).](98_vrdls_bayes_freq_files/figure-latex/vrdlsnull-1.pdf) 
