...
```{r, fig.cap="Keskaegne aristotellik maailm.", out.width='50%', echo=FALSE}
...
```{r, fig.cap="Ilma epitsükliteta ptolemailine mudel.",out.width='50%', echo=FALSE}
...
```{r, fig.cap="Ptolemaiose ja Kopernikuse mudelid on üllatavalt sarnased.", out.width='50%', echo=FALSE}
